...
public class FragmentBorrowing extends Fragment implements BorrowAdapter.Callback {
    ArrayList<BorrowDetail> borrowDetailArrayList;
    FirebaseDatabase firebaseDatabase;
    DatabaseReference reference;
    ImageView imageNoData;
    RecyclerView recyclerBorrowing;
    ...
    public void onResume() {
        ...
        recyclerBorrowing = view.findViewById(R.id.recyclerBorrowing);
        checkUser();
    }
    ...
    private  void  checkUser(){
        ...
        if (auth.getCurrentUser() == null){
            recyclerBorrowing.setVisibility(View.GONE);
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                            ...
                            if (borrowDetail.getStatus().equals(com.example.libraryutt.Status.Borrowing))
                            {
    ...
    private void setupViews(ArrayList<BorrowDetail> borrowDetails) {
        ...
        recyclerBorrowing.setLayoutManager(linearLayoutManager);
        adapter = new BorrowAdapter(borrowDetails, getContext(), this );
        recyclerBorrowing.setAdapter(adapter);
