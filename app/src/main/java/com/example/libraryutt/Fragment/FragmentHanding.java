...
public class FragmentHanding extends Fragment implements BorrowAdapter.Callback {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_handing, container, false);
        return view;
    }
    @Override
    public void onResume() {
        ...
        recyclerViewPromissory = view.findViewById(R.id.recyclerViewPromissoryNote);
        checkUser();
    }
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                            ...
                            if (borrowDetail.getStatus().equals(com.example.libraryutt.Status.Handling))
                            {
